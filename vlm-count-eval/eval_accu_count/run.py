...
def parse_args():
    ...
    parser.add_argument("--results_dir", type=str, default="qwen-2.5-VL")
    parser.add_argument("--question", type=str, default="PLEASE LOOKHow many red circle dots in the image?")
