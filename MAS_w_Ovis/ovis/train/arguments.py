...
class TrainingArguments(transformers.TrainingArguments):
    ...
    # MAS Loss arguments
    use_mas_loss: Optional[bool] = field(default=False)
    mas_loss_weight: Optional[float] = field(default=1.0)
    mas_tau: Optional[float] = field(default=0.5)
    mas_apply_layers: Optional[str] = field(default="all")
    mas_only: Optional[bool] = field(default=False)  # Use MAS loss only, disable standard loss
    
    # Freezing arguments
    freeze_vision_encoder: Optional[bool] = field(default=False)
    freeze_text_encoder: Optional[bool] = field(default=False)
    ...
    def __post_init__(self):
        ...
        if self.stage is not None and self.stage < 3:
